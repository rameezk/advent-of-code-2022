...
def drop_sand(
    win, p, screen, cave: CAVE, min_x, max_x, min_y, max_y: int
) -> (CAVE, bool):
    x, y = HOLE

    # Check if hole is blocked
    if cave[x, y] == CaveItem.SAND:
        return cave, False
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("rameezk - AOC 2022 Day 14 Part 2")
